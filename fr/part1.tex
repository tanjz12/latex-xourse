...
\subtitle{Premi\`ere Partie: Les bases}
...
\begin{itemize}
\item Il fait de jolies mises en page.
\begin{itemize}
\item Pour la composition de textes mathématiques en particulier
\end{itemize}
%
\item Il a \'et\'e cr\'e\'e par des scientifiques, pour des scientifiques
\begin{itemize}
\item Une grande communaut\'e active
\end{itemize}
%
\item C'est puissant - il y a beaucoup d'extension utiles.
\begin{itemize}
\item Des extensions th\`eses, diaporamas, tableurs, \ldots
\end{itemize}
\end{itemize}
\end{frame}
